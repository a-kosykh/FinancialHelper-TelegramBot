...
type ReportSenderClient interface {
	SendReport(ctx context.Context, in *Report, opts ...grpc.CallOption) (*ReportResponse, error)
}
...
func (c *reportSenderClient) SendReport(ctx context.Context, in *Report, opts ...grpc.CallOption) (*ReportResponse, error) {
	out := new(ReportResponse)
	err := c.cc.Invoke(ctx, "/proto_report.ReportSender/SendReport", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ReportSenderServer interface {
	SendReport(context.Context, *Report) (*ReportResponse, error)
...
func (UnimplementedReportSenderServer) SendReport(context.Context, *Report) (*ReportResponse, error) {
...
func _ReportSender_SendReport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto_report.ReportSender/SendReport",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReportSenderServer).SendReport(ctx, req.(*Report))
	}
...
var ReportSender_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto_report.ReportSender",
